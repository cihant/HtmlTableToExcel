...
{
    public class TableTagParserTests
    {
        [Fact]
        public void TableTagParser_ShouldTableNotNull()
        {
            var html = ReadFromFile("htmltable.html");
            Parsers.IHtmlTableParser htmlTableParser = new Parsers.TableTagParser();
        ...
        [Fact]
        public void TableTagParser_ShouldHaveThreeRows()
        {
        ...
        public void TableTagParser_ShouldCellTextHaveCorrectValues(int row, int col, string cellValue)
        {
            string html = ReadFromFile("htmltable.html");
        ...
        //[Fact]
        //public void TableTagParser_ShouldGenerateExcelFile()
        //{
        //    string html = ReadFromFile("htmltable.html");
        //    string targetFileName = "htmltable.xlsx";
